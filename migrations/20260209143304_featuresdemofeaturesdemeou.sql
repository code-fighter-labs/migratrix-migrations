...
CREATE TABLE `features_demo_features_deme__o_u` (
...
/*
 * ═══════════════════════════════════════════════════════════════
 * Generated: 2026-02-09 14:33:01 UTC
 * Statement Count: 1
...
-- Rollback for CREATE TABLE `features_demo_features_deme__o_u`
DROP TABLE IF EXISTS `features_demo_features_deme__o_u`;
